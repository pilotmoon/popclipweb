...
| `allowOther`   | Boolean              | Optional                     | For `multiple` options only. If true, adds an "Other…" choice to the list, allowing the user to enter a free-text value. Default is false.                                                                                                                      |
