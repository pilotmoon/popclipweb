...
| BarBee                                                          | May prevent PopClip's user interface appearing. Disable or configure BarBee as appropriate. (See [note](#a-note-about-icon-hider-apps)).                                                                                                                         | Working on it           |
| Bartender                                                           | May prevent PopClip's user interface appearing. Disable or configure Bartender as appropriate. (See [note](#a-note-about-icon-hider-apps)).                                                                                                                          | Working on it          |
...
| iBar                                                          | May prevent PopClip's user interface appearing. Disable or configure iBar as appropriate. (See [note](#a-note-about-icon-hider-apps)).                                                                                                                         | Working on it          |
| Ice                                                          | May prevent PopClip's user interface appearing. Disable or configure Ice as appropriate. (See [note](#a-note-about-icon-hider-apps)).                                                                                                                         | Working on it          |
| Hidden Bar                                                          | May prevent PopClip's user interface appearing. Disable or configure Hidden Bar as appropriate. (See [note](#a-note-about-icon-hider-apps)).                                                                                                                         | Working on it          |
...
| Vanilla                                                             | May prevent PopClip's user interface appearing. Disable or configure Vanilla as appropriate. (See [note](#a-note-about-icon-hider-apps)).                                                                                                                            | Working on it          |
...
**Bartender, Vanilla, Ice, Hidden Bar, BarBee, iBar**

Unfortunately, PopClip is currently incompatible with icon-hider apps such as Bartender. This is because PopClip always displays its menu below the current position of the menu bar icon. When Bartender hides the icon, it actually moves the icon offscreen. This causes PopClip to attempt to display its menu at offscreen coordinates, making the window invisible.
