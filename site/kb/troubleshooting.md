...
| Message: "PopClip won't start. The app appears to be corrupted. Please install a new copy." | Delte existing PopClip.app, then [download](https://www.popclip.app/download) a fresh copy. Unzip using macOS built-int unzip feature. Third party unzip app may not unzip properly (e.g),                                                                                                                                                                           |
