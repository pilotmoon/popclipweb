...
|                                                                                             | Check whether you have excluded the app from PopClip. See: [Rules](/guide/settings#excluded-apps-pane).                                                                                                                                                                                                                                                              |
...
| Message: "PopClip won't start. The app appears to be corrupted. Please install a new copy." | Delte existing PopClip.app, then [download](https://www.popclip.app/download) a fresh copy. Unzip using macOS built-in unzip feature. Third party unzip app may not unzip properly (e.g. Keka)                                                                                                                                                                       |
