...
<template>
    <div v-if="shouldShowInfoBox" class="warning custom-block">
        ...
        <p>The latest version of PopClip is not available on the the Mac App Store. You can continue to receive PopClip updates by <a href="/kb/mas">migrating to the Standalone edition</a>.</p>
    </div>    
</template>
